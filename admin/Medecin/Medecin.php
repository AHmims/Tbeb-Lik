...
<div class="wrapper">
  <div class="top_navbar">
    ...
    <div class="top_menu">
      <div class="logo"><img src="../../app/icon/logo_full.svg"> </div>
        ...
        <h1>Liste des Medecin</h1>
          ...
          <a class="btn-main" href="Ajoute.php">Ajouter</a> 
            ...
            if($status){
             ...
             echo    '<td>' . $item['MATRICULE'] .  '</td>'; 
             echo    '<td>' . $item['NOM_SPEC'] .  '</td>'; 
             echo    '<td>' . $item['DISPONIBLE'] .  '</td>'; 
             echo   '<td width=300>';
             echo   '<a class="btn btn-primary" href="Modifier.php?id=' .$item['MATRICULE'] . '"><span class="glyphicon glyphicon-pencil"></span> Modifier </a>';
             echo ' ';
             echo     '<a class="btn btn-danger" href="Suppression.php?id=' .$item['MATRICULE'] . '"><span class="glyphicon glyphicon-remove"></span> delete </a>'; 
             echo    '</td>';
